...
let blogName = "Tha Lab";
let authorName = "dynaTchy";
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const messages = [
    "bingus, pingus ",
    "sitin on my chair like a shrimp 🍤",
    "its raining outside, remindme of the time i use to play battlefield 1 on my ps4",
  ];

// This will grab the 
//with id="marquee-text"
...
//genera el header, esto no lo tocaria a no ser de que quiera añadir mas pestañas
let navbarHTML = '<ul class="navbar__list"> <li class="navbar__item"><a class="navbar__link" href="' + relativePath + '/index.html">Home</a></li>' + 
'<li class="navbar__item"><a class="navbar__link" href="' + relativePath + '/archive.html">Blog</a></li>' +
'<li class="navbar__item"><a class="navbar__link" href="' + relativePath + '/about.html">About Me</a></li> </ul>';
...
if (document.getElementById("navbar-link")) {
  document.getElementById("navbar-link").innerHTML = navbarHTML;
}
